...
@section('content')
    ...
    <p>
        ...
        @include('csvImport.modal', ['model' => 'Message'])
    ...
    <p>
        <ul class="list-inline">
            <li><a href="{{ route('admin.messages.index') }}" style="{{ request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">@lang('global.app_all')</a></li> |
            <li><a href="{{ route('admin.messages.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">@lang('global.app_trash')</a></li>
        </ul>
    </p>
